<?php
	...
	if($link && $logon){
		...
		$stringForSQL=$stringForSQL."'".$parsedstring[11]."'";
		$sqltext="INSERT INTO Clients(DateOfContract, IDWorker, LastName, FirstName, Patronymic, DataOfBirth, PassportNumber, PassportIssuedBy, PassportIssuedDate, IDTour, ProcentForWorker) VALUES (".$stringForSQL.")";
